...
class SocialMediaPost
{
    ...
    public function postToTwitter(string $text, array $imageNames, array $videoNames,  string $accessToken,string $accessTokenSecret) :array
    {
        try {
    ...
    private function loadImagesFromServer(array $imageNames) : array
    {
        $images = [];
    ...
    public function  obtenerIdAlbunFacebook(string $accessToken) : array
    {
        try {
    ...
    public function postToInstagram( string $text, array $imageNames, string  $accessToken, string $instagramAccountId): array
    {
        try {
            $data = [
                'caption' => $text,
    ...
    public function postToInstagramMultipleImages(string $text, array $image_urls, string $access_token) : array
{
    try {
